...
insert into branch (branch_id, name, address, city, state, zip)
values (null, 'San Francisco Branch', '601 Townsend St', 'San Francisco', 'CA', '94103');
...
insert into customer (cust_id, fed_id, cust_type_cd,
  address, city, state, postal_code)
values (null, '04-4444444', 'B', '801 N 34th St.', 'Seattle', 'WA', '98103');
insert into business (cust_id, name, state_id, incorp_date)
...
CREATE TABLE currentyearproduction
(   farmid  CHAR(3)     NOT NULL,
...
INSERT INTO currentyearproduction VALUES ('100','The Paradise',4400);
INSERT INTO currentyearproduction VALUES ('101','Evergreen',6200);
INSERT INTO currentyearproduction VALUES ('102','Red Delicious',9300);

INSERT INTO productionhistory VALUES ('100',2017,4100);
INSERT INTO productionhistory VALUES ('101',2017,5800);
INSERT INTO productionhistory VALUES ('102',2017,9400);
INSERT INTO productionhistory VALUES ('100',2016,3900);
INSERT INTO productionhistory VALUES ('101',2016,6400);
INSERT INTO productionhistory VALUES ('102',2016,9100);
...
CREATE TABLE rrank
(   title     VARCHAR(25)   NOT NULL,
    rrank   VARCHAR(25)   NOT NULL);

CREATE TABLE salary
(   rrank     VARCHAR(25)   NOT NULL,
    payment   int       NOT NULL);
    
INSERT INTO job VALUES ('Gordon Russell', 'Lecturer');
INSERT INTO job VALUES ('Andrew Cumming', 'Teaching fellow');
INSERT INTO job VALUES ('Jim Smith', 'Technician');

INSERT INTO rrank VALUES ('Lecturer', 'LECT1');
INSERT INTO rrank VALUES ('Teaching fellow', 'LECT2');
INSERT INTO rrank VALUES ('Technician', 'TECH1');
...
INSERT INTO breakfast VALUES ('Oatmeal');
INSERT INTO breakfast VALUES ('Coffee');
INSERT INTO breakfast VALUES ('Apple cinnamon crepes');

INSERT INTO lunch VALUES ('Blueberries');
INSERT INTO lunch VALUES ('Sausage baked penne');
INSERT INTO lunch VALUES ('Homestyle chicken');
INSERT INTO lunch VALUES ('Coffee');
